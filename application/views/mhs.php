  ...
  <body>
	<div class="panel panel-default">
	    ...
	    <div class="panel-body">
			...
			<div class="row">
		    <div class="col-lg-4">
			<form class="form-horizontal" action="<?php echo site_url('mahasiswa/eksekusi_edit'); ?>" method="post" enctype="multipart/form-data">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
					  <input type="text" class="form-control" id="nim" name="nim" value="<?php echo $a->nim;?>">
					</div>
				</div>
				<div class="form-group">
					...
					<div id="jrs" class="col-sm-10">
					    <select class="form-control" id="jurusan" name="jurusan">
							...
							<?php
							if($a->jurusan=="Manajemen Informatika"){
							?>
							...
							<?php 	
							}else if($a->jurusan=="Teknik Komputer"){
							?>
								<option value="Manajemen Informatika">Manajemen Informatika</option>
								<option value="Komputer Akuntansi">Komputer Akuntansi</option>
								<option value="Manajemen Pemasaran">Manajemen Pemasaran</option>
							<?php
							}else if($a->jurusan=="Komputer Akuntansi"){
							?>
								<option value="Manajemen Informatika">Manajemen Informatika</option>
								<option value="Teknik Komputer">Teknik Komputer</option>
								<option value="Manajemen Pemasaran">Manajemen Pemasaran</option>
							<?php	
							}else if($a->jurusan=="Manajemen Pemasaran"){
							?>
								<option value="Manajemen Informatika">Manajemen Informatika</option>
								<option value="Teknik Komputer">Teknik Komputer</option>
								<option value="Komputer Akuntansi">Komputer Akuntansi</option>
